...
echo "  4. /pm:epic-sync <name>      - Push to Git Service"
...
echo "  /pm:epic-sync <name>      - Push epic and tasks to Git Service"
...
echo "  /pm:issue-sync <num>      - Push updates to Git Service"
...
echo ""
echo "🔗 Sync Commands"
echo "  /pm:sync               - Full bidirectional sync with Git Service"
echo "  /pm:import <issue>     - Import existing Git Service (Github/Gitlab/Gitea) issues"
echo ""
...
echo "  /pm:init               - Install dependencies and configure Git Service"
